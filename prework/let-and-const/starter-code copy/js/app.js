...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT We changed the scope of the variable on line 33 by changing 'var' to 'let', containing its scope to use within the code block in which it's defined
  console.log(viewed);
